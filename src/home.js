        ...
        return (
            <div className={"container"}>
                ...
                <div className={"right_box"}>
                    ...
                    <div className={"email_input"}><Input onChange={this.handleEmail} addonBefore={<HomeOutlined/>}
                                                          placeholder={"Enter your email"}/></div>
                    <div className={"password_text"}>Password</div>
                    <div className={"pwd_input"}><Input onChange={this.handlePwd} addonBefore={<CompassOutlined/>}
                    ...
                    <div><Button onClick={this.submit} style={{
                        width: "100%",
                        height: "3rem",
                        marginBottom: "1rem",
                        backgroundColor: "darkgreen"
                    }} type="primary">login</Button></div>
